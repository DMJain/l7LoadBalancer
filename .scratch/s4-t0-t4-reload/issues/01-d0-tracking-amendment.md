...
- [x] `MILESTONES.md` Sprint 4 deliverables gain one bullet: the programmatic
...
- [x] `PROGRESS.md` gains Sprint 4 entries S4.T0, S4.T1, S4.T2, S4.T3.0,
...
- [x] `PROGRESS.md` → *Proposed tickets (awaiting owner approval)* gains four
...
- [x] `PROGRESS.md`'s status line reads Sprint 4 in progress.
- [x] Lands alone as `docs(milestones): add S4 reload tickets and seam deliverable`
